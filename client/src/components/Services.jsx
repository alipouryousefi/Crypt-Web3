...
const Services = () => {
  return (
    <div className="flex w-full flex-col md:flex-row items-center justify-center gradient-bg-services">
      <div className="flex flex-col items-center justify-between md:p-20 py-12 px-4">
        <div className="flex-1 flex flex-col justify-start items-start">
          <h1 className="text-white text-3xl sm:text-5xl py-2 text-gradiant">
            Services that we
            <br />
            continue to improve
          </h1>
